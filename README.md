...
- **Projets** : Galerie avec overlays d'interaction
...
├── images/
│   ├── carl-profile.png   # Photo de profil principale
│   └── carl-profil1.jpg   # Photo section À propos
├── document/
│   └── Carl_Smith_ETIENNE_CV.pdf  # CV téléchargeable
...
- **CV** : Remplacer le PDF dans `/document`

## 📞 Contact

- **Email** : carlsmithetienne2000@gmail.com
- **Téléphone** : +509 36 78 78 53
- **Localisation** : Tabarre 48, Port-au-Prince, Haïti
